...
#ifndef Combine_Constants_h
#define Combine_Constants_h

#define backgroundBlue [UIColor colorWithHue:.555555556 saturation:0.75 brightness:0.8 alpha:1.0];
#define calculatorWindowBlue [UIColor colorWithHue:.555555556 saturation:0.75 brightness:0.5 alpha:1.0];
